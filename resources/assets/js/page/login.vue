    ...
    <div class="layout">
        <div class="login-bg">
            ...
            <Form class="login" ref="formInline" :model="formInline" :rules="ruleInline" post="">
                ...
                <FormItem prop="verification" style="text-align:left" v-if="whetherNeedCaptcha">
    ...
    handleSubmit(name) {
      this.$refs[name].validate(valid => {
        if (valid) {
          ...
          if (this.whetherNeedCaptcha) {
              params.captcha_key = this.captchaKey;
              params.captcha_code = this.formInline.verification;
          }
          this.$http
            ...
            .then(
              ...
              err => {
                this.whetherNeedCaptcha = err.data.whetherNeedCaptcha;
